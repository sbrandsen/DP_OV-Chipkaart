...
public class AdresDAOPsql implements AdresDAO {
    ...
    public boolean save(Adres adres) throws SQLException {
        try{
            ...
            prepStatement.setInt(6, adres.getReiziger_id());
    ...
    public Adres findbyId(int id) {
        try{
            ...
            while (rs.next() ) {
                adres = new Adres(id, rs.getString("adres_id"), rs.getString("huisnummer"),
                        rs.getString("straat"), rs.getString("woonplaats"), rs.getInt("reiziger_id"));
            }

            return adres;
        } catch(Exception ex) {
            System.out.println("Error - could not find adres by id: " + id);
            return null;
        }
    }
